...
stan_trace(glm_post1, pars=c("(Intercept)","AdultMort", "UnFiveDths", "InfDth","GDP", "BMI", "DTP3", "Pol3", "Schooling", "HIVAids","sigma"))
```
...
R Hat compares the variability in sampled parameter estimates across all chains combined with the variability within each individual change. $R = 1$ shows stability across chains.
...
```{r}
# 
stan_hist(glm_post1, pars=c("(Intercept)","AdultMort", "UnFiveDths", "InfDth","GDP", "BMI", "DTP3", "Pol3", "Schooling", "HIVAids","sigma"), bins=40)
```

#### Extract posterior samples

```{r}
post_samps <- as.data.frame(glm_post1, pars=c("(Intercept)","AdultMort", "UnFiveDths", "InfDth","GDP", "BMI", "DTP3", "Pol3", "Schooling", "HIVAids","sigma"))

# calculate the median of each column.
round(apply(post_samps, 2, median),5)
```

#### Using Frenquentist method to build a regression model
...
The maximum likelihood estimates for the intercept and slopes are nearly identical to the Bayesian posterior median values.
...
posterior_vs_prior(glm_post1, group_by_parameter = TRUE, pars=c("(Intercept)","AdultMort", "UnFiveDths", "InfDth","GDP", "BMI", "DTP3", "Pol3", "Schooling", "HIVAids","sigma"))
```
